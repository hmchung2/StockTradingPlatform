                ...
                <div class="row">
					...
					<div class="col-lg-4 col-md-6 col-12">
						<div class="widget">
							...
							<ul class="list list-unstyled mb-10">
								...
								<li> <i class="fa fa-envelope"></i> <span class="me-5">hello@multipurposethemes.com </span> | <span class="ms-5">support@multipurposethemes.com </span></li>
							</ul>
					...
					<div class="col-lg-3 col-md-6 col-12">
                        <div class="widget">
							...
							<p class="text-capitalize mb-20">Sign Up and get the latest offers.</p>
                            <div class="mb-20">
								<form class="" action="" method="post">
									<input name="email" required="required" class="form-control" placeholder="Your Email Address" type="email">
									<button name="submit" value="Submit" type="submit" class="btn btn-info mt-5"> Get notified </button>
								</form>
							</div>
                        </div>
                    </div>
		...
		<div class="footer-bottom bg-light">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 text-md-start text-center"> © 2020 <span class="text-dark">CryptoCurrency</span>  All Rights Reserved.</div>
